		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Goods Receiver Management",
									"targetURL": "#goodsreceiversmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"goodsreceiversmanagement-display": {
								"semanticObject": "goodsreceiversmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=goodsreceiversmanagement",
									"url": sap.ui.require.toUrl("goodsreceiversmanagement")
								}
							}
						}
					}
