sap.ui.define([
    ...
    return Controller.extend("goodsreceiversmanagement.controller.BaseController", {
        ...
        setModelTQA: function (token) {
            ...
            TQAModel = new sap.ui.model.odata.v2.ODataModel({
                ...
                annotationURI: "/sap/opu/odata/IWFND/CATALOGSERVICE;v=2/Annotations(TechnicalName='%2FTQA%2FOD_GOODS_RECEIVERS_ANNO_MDL',Version='0001')/$value/",
                headers: {
                    "authorization": token,
                    "applicationName": "GOODS_RECEIVERS"
                }
            });
